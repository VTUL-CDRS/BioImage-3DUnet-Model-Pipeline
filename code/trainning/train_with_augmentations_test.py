...
def plot_loss_and_iou(history, currenttime, augmentation):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(currenttime+'augmentations_loss_9.png')
    ...
    plt.ylabel('IOU')
    plt.legend()
    plt.savefig(currenttime+'augmentations_iou_9.png')
    ...
    plt.ylabel('f1_score')
    plt.legend()
    plt.savefig(currenttime+'f1_score_augmentations_9.png')
...
def main():
    ...
    # augmentation ="gfre"
    # modelfile = "/home/chongyuh/3dunet/model/gfre.h5"
    # inputfolder = "/home/chongyuh/3dunet/data/images/"
    # maskfolder = "/home/chongyuh/3dunet/data/masks/"
    ...
    augmentation ="all"
    modelfile = "/home/chongyuh/3dunet/model/all.h5"
    inputfolder = "/home/chongyuh/3dunet/data/images/"
    maskfolder = "/home/chongyuh/3dunet/data/masks/"
