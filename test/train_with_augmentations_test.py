...
def generate_augmented_data(train_images, mask_images, augmentation_type, num_augmentations=5):
    imagelist = []
    masklist = []
...
def train_model(model, X_train, y_train, X_test, y_test, checkpoint_path, epochs, batch_size=1):
