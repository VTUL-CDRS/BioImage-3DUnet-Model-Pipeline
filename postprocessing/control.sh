...
do 
  ...
  do
    # echo $thr $cc
    # python analysis.py --pred-file $RPRED/control4/pred.tif --mask-file $RMASK/ControlNeuron4_mask.tif \
    #   --outdir $RPRED/control4/ --threshold $thr --clear-size $cc --n-jobs 32
    
    echo $thr $cc
    python analysis.py --pred-file $RPRED/control8/pred.tif --mask-file $RMASK/ControlNeuron8_mask.tif \
      --outdir $RPRED/control8/ --threshold $thr --clear-size $cc --n-jobs 32
    
    # echo $thr $cc
    # python analysis.py --pred-file $RPRED/control1/pred.tif --mask-file $RMASK/ControlNeuron1_mask.tif \
